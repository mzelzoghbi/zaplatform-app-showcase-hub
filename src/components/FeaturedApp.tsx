        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 fade-in-element" style={{ '--delay': '300ms' } as React.CSSProperties}>
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg p-8">
              ...
              <div className="text-center">
                <Button 
                  className="bg-za-purple hover:bg-za-accent-purple text-white"
          ...
          <div className="space-y-8 fade-in-element" style={{ '--delay': '500ms' } as React.CSSProperties}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="border-0 shadow-md">
                  <CardContent className="p-4 flex items-start space-x-3">
                    <div className="bg-za-purple/10 p-2 rounded-full">
                      <Image size={20} className="text-za-purple" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-md">
                  <CardContent className="p-4 flex items-start space-x-3">
                    <div className="bg-za-purple/10 p-2 rounded-full">
                      <ArrowRight size={20} className="text-za-purple" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-md">
                  <CardContent className="p-4 flex items-start space-x-3">
                    <div className="bg-za-purple/10 p-2 rounded-full">
                      <Package size={20} className="text-za-purple" />
                    </div>
                    <div>
                ...
                <Card className="border-0 shadow-md">
                  <CardContent className="p-4 flex items-start space-x-3">
                    <div className="bg-za-purple/10 p-2 rounded-full">
                      <Calendar size={20} className="text-za-purple" />
                    </div>
                    <div>
            ...
            <div>
              ...
              <Button 
                variant="outline" 
                className="border-za-purple text-za-purple hover:bg-za-purple hover:text-white"
                onClick={() => window.open('https://zapixel.zaplatform.com', '_blank')}
              >
                Learn More
